...
import md5 from "../3rd-party/md5.js";
...
export default class Digest extends AuthUiBase {
  ...
  _qopTemplate() {
    ...
    >
      ...
      <anypoint-listbox
        ...
        .selected="${qop}"
        @selected-changed="${ctx.selectHandler}"
        ?compatibility="${anypoint}"
        ?disabled="${disabled||readOnly}"
        attrforselected="data-qop"
      >
        <anypoint-item ?compatibility="${anypoint}" data-qop="auth"
          >auth</anypoint-item
        >
        <anypoint-item ?compatibility="${anypoint}" data-qop="auth-int"
  ...
  _hashAlgorithmTemplate() {
    ...
    >
      ...
      >
        <anypoint-item ?compatibility="${anypoint}" data-algorithm="MD5"
          >MD5</anypoint-item
        >
        <anypoint-item
          ?compatibility="${anypoint}"
